function [k, lambda_pixel, lambda_grad, S] = blind_deconv_main_C(blur_B, k, ...
...
%             By=L0Smoothing(By,8e-5);
    ...
    %%%%%%%%%%%%%%%%%%%%%%
    %--------------------------------------------------------------------------------------
    figure(2);subplot(1,3,1);imshow(Sx+Sy,[]);title(['Sx+Sy | ' num2str(num_scales)]);
    %--------------------------------------------------------------------------------------
    Sx_=Sx;
    Sy_=Sy;
    %=============================
