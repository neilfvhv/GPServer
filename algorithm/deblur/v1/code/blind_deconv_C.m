function [kernel, interim_latent] = blind_deconv_C(y, lambda_pixel, lambda_grad, opts)
% 
...
%     end
  ...
  %-----------------------------------------------------------%
  [ks, lambda_pixel, lambda_grad, interim_latent] = blind_deconv_main_C(ys, ks, lambda_pixel,...
